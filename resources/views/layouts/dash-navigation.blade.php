<nav class="navbar navbar-expand-lg navbar-light bg-success border-bottom fixed-top">
    ...
    <div class="container">        
        ...
        <ul class="navbar-nav ms-auto">
            <li class="nav-item">
                <form method="POST" action="{{ route('admin.exitCustomerDashboard') }}">
                    @csrf
    ...
    <div class="offcanvas-body">
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2">
                <form method="POST" action="{{ route('admin.previewCustomerDashboard') }}">
                @csrf
                <button type="submit" class="nav-link text-white" ><i class="fas fa-tachometer-alt me-2"></i>View Customer Dashboard</button>
                </form>
            </li>
...
@can('viewAsCustomer')
<div class="offcanvas offcanvas-start bg-success text-white" id="ViewCustomerSidebar">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title">Menu</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"></button>
    </div>
